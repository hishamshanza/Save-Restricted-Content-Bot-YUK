...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8610528914:AAEzkgvl7MfC0u-4WePLDfYkQanRcQVniiE")
...
ADMINS = int(os.environ.get("ADMINS", "7042953166"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1003697179701")

# Your Mongodb Database Url
# Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_URI = os.environ.get("DB_URI", "mongodb+srv://hishammon:hishammon@cluster0.2g7bqyf.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
